    ...
    module.exports = new XP.Class('SmartQueue', {
        ...
        _isInQueue: {
            value: function (ticket) {
                return this._queue[ticket] && this._queue[ticket].value;
            }
        },
        ...
        next: {
            value: function (cb) {
                ...
                if (self._isInQueue(self._currentTicket)) {
                    self._removeClient(self._currentTicket);
                }
